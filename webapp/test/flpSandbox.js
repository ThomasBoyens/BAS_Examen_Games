		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List of games",
									"targetURL": "#beapeduzsdgamelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapeduzsdgamelist-display": {
								"semanticObject": "beapeduzsdgamelist",
								"action": "display",
								"description": "A Fiori application for a game renting app",
								"title": "List of games",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.edu.zsdgamelist",
									"url": sap.ui.require.toUrl("be/ap/edu/zsdgamelist")
								}
							}
						}
					}
